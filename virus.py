...
'оаэ':'United Arab Emirates','кувейт': 'Kuwait','оман': 'Oman', 'казахстан':'Kazakhstan','португалия': 'Portugal','египет': 'Egypt',
...
'беларусь':'Belarus','венесуэла': 'Venezuela','бахрейн': 'Bahrain','армения': 'Armenia','австрия': 'Austria','молдова': 'Moldova','ливан': 'Lebanon','узбекистан': 'Uzbekistan',
